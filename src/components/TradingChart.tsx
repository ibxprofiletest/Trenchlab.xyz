...
export default function TradingChart() {
  ...
  const showAll = () => {
    setVisibleModels(new Set(AI_MODELS.map(m => m.id)));
  };
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="bg-background border-2 border-b-0 border-border px-3 sm:px-6 py-2 sm:py-3">
        <div className="flex items-center gap-1 sm:gap-2 flex-wrap">
          <button className="px-2 sm:px-4 py-1 sm:py-1.5 text-[10px] sm:text-xs font-bold border-2 border-border bg-background text-foreground hover:bg-muted transition-colors">
            <span className="hidden sm:inline">ZOOM IN </span>+
          </button>
          <button className="px-2 sm:px-4 py-1 sm:py-1.5 text-[10px] sm:text-xs font-bold border-2 border-border bg-background text-foreground hover:bg-muted transition-colors">
            <span className="hidden sm:inline">ZOOM OUT </span>−
          </button>
          <button className="px-2 sm:px-4 py-1 sm:py-1.5 text-[10px] sm:text-xs font-bold border-2 border-border bg-primary text-primary-foreground hover:bg-primary/90 transition-colors">
      ...
      {/* Chart */}
      <div className="flex-1 bg-card border-2 border-border" style={{ minHeight: '400px' }}>
